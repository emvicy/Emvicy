...
//            )
    ...
    {
        Event::run('mvc.db.model.dbpdo.query.sql', $sSql . (' /* ' . substr(__FILE__, strlen($GLOBALS['aConfig']['MVC_BASE_PATH'])) . ', ' . __LINE__ . ' */ ') . "\n");
    ...
    {
        Event::run('mvc.db.model.dbpdo.fetchAll.sql', $sSql . (' /* ' . substr(__FILE__, strlen($GLOBALS['aConfig']['MVC_BASE_PATH'])) . ', ' . __LINE__ . ' */ ') . "\n");
    ...
    {
        Event::run('mvc.db.model.dbpdo.fetchRow.sql', $sSql . (' /* ' . substr(__FILE__, strlen($GLOBALS['aConfig']['MVC_BASE_PATH'])) . ', ' . __LINE__ . ' */ ') . "\n");
        $oStmt = $this->query($sSql);
