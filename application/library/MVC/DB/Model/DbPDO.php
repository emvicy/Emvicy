...
//            )
    ...
    {
        Event::run('mvc.db.model.dbpdo.query.sql', $sSql . (' /* ' . __FILE__ . ', ' . __LINE__ . ' */ ') . "\n");
    ...
    {
        Event::run('mvc.db.model.dbpdo.fetchAll.sql', $sSql . (' /* ' . __FILE__ . ', ' . __LINE__ . ' */ ') . "\n");
    ...
    {
        Event::run('mvc.db.model.dbpdo.fetchRow.sql', $sSql . (' /* ' . __FILE__ . ', ' . __LINE__ . ' */ ') . "\n");
        $oStmt = $this->query($sSql);
